...
public class MyImage {
	...
	/**
	 * This is an attatched class for assignment 2 in introduction to computer
	...
	/**
	 * 
	 * @param fileName - A path to an existing image in the PC (to be loaded). (Ex:
	 *                 "C://Documents and Settings/user1/Desktop/cat.jpg").
	 * @return RGB image (img) represented as a 3D array, where img[0] - Red
	 *         channel, img[1] - Green channel, img[2] - Blue channel.
	 */
...
//				e.printStackTrace();
	...
	/**
	 * 
	 * @param fileName - A path to an image in the PC (to be saved). (Ex:
	 *                 "C://Documents and Settings/user1/Desktop/catCopy").
	 * @param pixels   - RGB image represented as a 3D array to be saved in the
	 *                 given path.
	 */
	...
	/**
	 * 
	 * @param fileName - A path to an image in the PC. (Example: "C://Documents and
	 *                 Settings/user1/Desktop/catCopy" - where "catCopy" is the name
	 *                 of the new image).
	 * @param pixels   - gray-scale image represented as a 2D array to be saved in
	 *                 the given path.
	 */
	public static void writeImageToFile(String fileName, int[][] pixels) {
